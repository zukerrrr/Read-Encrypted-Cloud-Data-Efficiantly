...
<pre>
<h2><font size="6">Retrieval of Encrypted Cloud Data
 Using Multikeyword </font></h2></pre>
</div>
<div class="topmenu">
<ul>
  <li
...
<tr>
<td><font size="+1" color="#FFFFFF">Userid</font></td>
<td><font size="+1" color="#FFFFFF">name</font></td>
<td><font size="+1" color="#FFFFFF">Emailid</font></td>
<td><font size="+1" color="#FFFFFF">DOB</font></td>
<td><font size="+1" color="#FFFFFF">Address</font></td>
<td><font size="+1" color="#FFFFFF">Country</font></td>
<td><font size="+1" color="#FFFFFF">MobileNo</font></td>
</tr>
<%
String o1="server";
...
try
{
		...
		String sql1="select userid,name,emailid,dob,address,country,mobilenumber from regstration where usertype='"+o1+"'";
...
<td><font  color="#FFFFFF"><%=e%></font></td>
...
<div class="mainmenu">
<h2 class="sidebar1">ServerList</h2>
<font size="+1">
<ul >
