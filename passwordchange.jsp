...
<h2 align="center">Password Change</h2>
		...
		<table class="s1" height="120" align="right" >
  ...
  <tr ><td class="s1" align="right">Confirm Password &nbsp;&nbsp;&nbsp;:</td>
	...
	<tr align="char"><tr align="justify"></tr>
			
			
			
			<table style="position:absolute" align="right" height="120" >
			<tr>
			
			
			
			<td>
				<td width="150" height="100" align="right">
				<img src="images/c.jpg" width="275" height="200" align="right">
				</td></td>
				</tr></table>
