...
<form action="fileupload1.1.jsp" method="post" name="f1" onsubmit="return valid1()">
...
<table>
<td>
<td><img src="images/s.jpeg" width="180" height="150"></td>
...
<tr>
<td>
<td><font color="#33CC33" size="+1">Select any Server</font>&nbsp;&nbsp;&nbsp;&nbsp;:</td>
